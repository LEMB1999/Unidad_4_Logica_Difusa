...
const img = document.getElementById("img_estado")
...
boton.addEventListener("click", () => {
  ...
  if(temperatura.value != ""){
    ...
    if(resultado == "Covid"){
       ...
       img.setAttribute("src","./img/covid.jpg")
    }
    else if(resultado == "Sospechoso"){
       message.style.color = "gray"     
       img.setAttribute("src","./img/sospechoso.jpg")
    }
    else{
       message.style.color = "green"
       img.setAttribute("src","./img/pasa.jpg")
    }
    ...
    h2resultado.style.display = "flex"
    h2resultado.style.alignItems = "center"

    h2resultado.innerHTML = "<span style ='font-size:30px; margin-right:10px;'>Su diagnostico es: </span> " 
    h2resultado.appendChild(message)
